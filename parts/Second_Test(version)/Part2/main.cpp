...
int main() {
    ...
    Matrix w1 = read_binary_matrix("mnist-fc/fc1.weight", w1_rows, w1_cols);
    Matrix b1 = read_binary_matrix("mnist-fc/fc1.bias",   b1_rows, b1_cols);
    Matrix w2 = read_binary_matrix("mnist-fc/fc2.weight", w2_rows, w2_cols);
    Matrix b2 = read_binary_matrix("mnist-fc/fc2.bias",   b2_rows, b2_cols);
